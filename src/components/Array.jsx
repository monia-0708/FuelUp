  ...
  const stacje = [
    {
      ...
      prices: 
      ["benzyna 95 - 5,55 zl", "diesel ON - 6,55 zl", "gaz - 3,40 zl"],
    },
    {
      id: 2,
      ...
      prices: ["benzyna 95", "diesel ON", "gaz"],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      prices: ["benzyna 95 - 5,55 zl", "diesel ON - 6,55 zl", "gaz - 3,40 zl"],
    },
  ];
    ...
    <div>
      ...
      <ul>
        {stacje.map((stacja) => (
          <li key={stacja.id}>
            <h2>{stacja.name}</h2>
            <p>Address: {stacja.address}</p>
            <p>Prices: {stacja.prices.join(", ")}</p>
          </li>
        ))}
      </ul>
    </div>
